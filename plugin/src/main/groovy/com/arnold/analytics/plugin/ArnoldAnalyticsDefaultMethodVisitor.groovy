...
class ArnoldAnalyticsDefaultMethodVisitor extends AdviceAdapter {

    String methodName

    ArnoldAnalyticsDefaultMethodVisitor(MethodVisitor mv, int access, String name, String desc) {
        super(ArnoldAnalyticsUtil.ASM_VERSION, mv, access, name, desc)
        methodName = name
        if (Logger.debug) {
